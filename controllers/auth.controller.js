/**
 * I need to write the controller / logic to register
 */
...
exports.signup = async (req ,res) =>{
    ...
    const request_body = req.body // Request body in the form of js object 

    // 2. Insert the data in the Users Collection in MongoDbody
